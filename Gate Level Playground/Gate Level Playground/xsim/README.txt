...
#
# Generated by export_simulation on Wed Jul 16 20:12:00 CEST 2025
#
################################################################################
...
'-reset_run' switch to the './and2.sh' script.
...
./and2.sh -noclean_files

For more information on the script, please type './and2.sh -help'.
