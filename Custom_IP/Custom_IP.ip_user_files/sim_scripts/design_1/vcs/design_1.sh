...
#
# Generated by Vivado on Thu Jul 24 17:06:27 CEST 2025
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/8cdf/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/8cdf/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_12 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/8cdf/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/1033/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work zynq_ultra_ps_e_vip_v1_0_12 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/8cdf/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/8cdf/hdl/zynq_ultra_ps_e_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Custom_IP.gen/sources_1/bd/design_1/ipshared/8cdf/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
    "$ref_dir/../../../bd/design_1/ip/design_1_zynq_ultra_ps_e_0_0/sim/design_1_zynq_ultra_ps_e_0_0_vip_wrapper.v" \
    "$ref_dir/../../../bd/design_1/ipshared/52ec/blink.v" \
