...
HD_PWD='/home/call_me_utka/Documents/Projects/aes-ultra96-v2-playground/nbody_simulation/nbody/nbodyproj.runs/design_fp_mult_floating_point_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_fp_mult_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_fp_mult_floating_point_0_0.tcl
