...
ISEStep( "vivado",
         "-log design_float_to_fixed_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_float_to_fixed_floating_point_0_0.tcl" );
