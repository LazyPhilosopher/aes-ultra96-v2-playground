...
ISEStep( "vivado",
         "-log design_fixed_to_float_floating_point_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_fixed_to_float_floating_point_0_0.tcl" );
