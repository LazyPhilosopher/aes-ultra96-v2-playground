...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net M01_ARESETN_1 [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_1/interconnect_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports pl_clk1] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/M01_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins clk_wiz_0/reset] [get_bd_pins proc_sys_reset_0/peripheral_reset] [get_bd_pins proc_sys_reset_1/ext_reset_in]
  connect_bd_net -net proc_sys_reset_1_peripheral_reset [get_bd_ports peripheral_reset] [get_bd_pins proc_sys_reset_1/peripheral_reset]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk2 [get_bd_ports pl_clk2_300MHz] [get_bd_pins zynq_ultra_ps_e_0/pl_clk2]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk3 [get_bd_ports pl_clk3_374MHz] [get_bd_pins zynq_ultra_ps_e_0/pl_clk3]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs APB_M2/Reg] SEG_APB_M2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs APB_M3/Reg] SEG_APB_M3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs APB_M/Reg] SEG_APB_M_Reg
