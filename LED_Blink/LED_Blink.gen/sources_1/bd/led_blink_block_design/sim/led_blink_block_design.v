...
//Date        : Fri Jul 11 13:34:14 2025
//Host        : call-me-utka running 64-bit Ubuntu 22.04.5 LTS
//Command     : generate_target led_blink_block_design.bd
//Design      : led_blink_block_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "led_blink_block_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=led_blink_block_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "led_blink_block_design.hwdef" *) 
module led_blink_block_design
   (LED);
  output LED;

  wire Net;
  wire led_blink_0_led;

  assign LED = led_blink_0_led;
  led_blink_block_design_led_blink_0_0 led_blink_0
       (.clk(Net),
        .led(led_blink_0_led));
  led_blink_block_design_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
